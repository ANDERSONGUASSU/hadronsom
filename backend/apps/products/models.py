...
class Products(models.Model):
    ...
    detailed_description = models.TextField(blank=True, verbose_name="Descrição detalhada do Produto")
    ...
    sale_price = models.DecimalField(max_digits=8, decimal_places=2, blank=True,
                                     null=True, verbose_name="Preço Promocional")
...
class Color(models.Model):
    product = models.ForeignKey(Products, on_delete=models.CASCADE, related_name='cores')
...
class ProductSpecification(models.Model):
    product = models.ForeignKey(Products, on_delete=models.CASCADE, related_name='Especificações')
...
class ProductImage(models.Model):
    product = models.ForeignKey(Products, on_delete=models.CASCADE, related_name='product_image_set')
    image = ImageField(
